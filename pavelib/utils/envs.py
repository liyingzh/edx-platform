...
class Env(object):
    ...
    SETTINGS = 'bok_choy' if SERVER_HOST == '0.0.0.0' else 'bok_choy_docker'
    ...
    BOK_CHOY_MONGO_HOST = 'edx.devstack.mongo' if SERVER_HOST != '0.0.0.0' else '0.0.0.0'
    BOK_CHOY_MONGO_DATABASE = "test"
    BOK_CHOY_CACHE_HOST = 'edx.devstack.memcached' if SERVER_HOST != '0.0.0.0' else '0.0.0.0'
